                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{ Auth::user()->role->name ?? 'Admin' }}</span></div>
                                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">{{ Auth::user()->email ?? 'admin@gmail.com'}}</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
                        ...
                        <div class="menu-item px-5">
                            <form action="{{ route('logout') }}" method="post" id="form-logout">
                                @csrf
                                <a href="#" onclick="document.getElementById('form-logout').submit();" class="menu-link px-5">Sign Out</a>
                            </form>
                        </div>
                        <!--end::Menu item-->
                    </div>
