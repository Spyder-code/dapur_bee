...
<head>
    ...
    <title>@yield('title','Flower House')</title>
    <meta name="robots" content="noindex, follow" />
    <meta name="description" content="@yield('description','Toko Bunga Flower House menyediakan berbagai macam bunga papan, bunga tangan, bunga salib, bunga potong dan lain-lain. ')">
    ...
    <meta property="og:title" content="@yield('title','Flower House')">
    <meta property="og:description" content="@yield('description','Toko Bunga Flower House menyediakan berbagai macam bunga papan, bunga tangan, bunga salib, bunga potong dan lain-lain. ')">
    <meta property="og:image" content="@yield('img-meta',asset('assets/images/logo/logo.png'))">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="{{ url('/') }}">
    <meta property="twitter:title" content="@yield('title','Flower House')">
    <meta property="twitter:description" content="@yield('description','Toko Bunga Flower House menyediakan berbagai macam bunga papan, bunga tangan, bunga salib, bunga potong dan lain-lain. ')">
    <meta property="twitter:image" content="@yield('img-meta',asset('assets/images/logo/logo.png'))">
